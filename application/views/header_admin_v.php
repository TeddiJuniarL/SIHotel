    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?PHP echo site_url(); ?>"><img src="<?PHP echo base_url(); ?>assets/img/logos/"></a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a <?PHP if($this->uri->segment(1)=='konfirmasi') echo ' class="active"';?> href="<?PHP echo site_url(); ?>">Konfirmasi</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            <a <?PHP if($this->uri->segment(1)=='pegawai') echo ' class="active"';?> href="<?PHP echo site_url(); ?>"><i class="fa fa-users fa-fw"></i> Pegawai</a>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a <?PHP if($this->uri->segment(1)=='laporan_harian') echo ' class="active"';?> href="<?PHP echo site_url();?>">Excel</a>
                                </li>
                                <li>
                                    <a <?PHP if($this->uri->segment(1)=='laporan_mingguan') echo ' class="active"';?> href="<?PHP echo site_url();?>">PDF</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
